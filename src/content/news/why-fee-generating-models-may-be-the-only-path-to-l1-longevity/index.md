---
title: Why Fee-Generating Models May Be the Only Path to L1 Longevity
description: Inflationary L1 models lead to dilution and collapse. Alephium's
  Pepper argues fee-generation & its Aligned Ecosystem Loop are the only path to
  >100-year longevity.
seoDescription: L1 economic longevity depends on fees, not inflation. Learn how
  Alephium's deflationary, fee-generating Phase Two turns $ALPH into a
  productive, self-sustaining asset.
date: 2025-11-14T12:00:00.000Z
spotlight: true
featuredImage: planttrees.png
---
...
I see a network and team that wants to create scarcity (burns and buybacks) and become stronger with every interaction and transactions (rewarding loyal stakers with generated fees). 
...
The model incentivizes short-term speculation rather than long-term network participation. Participants are motivated to "farm" the inflationary rewards and immediately sell them, increasing sell-side pressure on the native asset.
...
**Alephium's Phase Two,** “Aligned Economics”, could be seen as a critique of this inflationary paradigm. In reality, I think it’s more of an adjustment, or an alternative path. Take some of the good aspects of it, then mix in deflationary aspects too. This only works, however, if your technical foundation is robust.
...
The core building block of Phase Two is the Core dApp (CLMM DEX). Its utility is designed to reverse the financial decay of inflation. I believe it can do that.

**Usage Fuels Deflation**: Every transaction on the Core dApp will generate swap fees. 100% of these swap fees will then be utilized for $ALPH buybacks and burns. This creates a powerful, persistent deflationary force that structurally increases the value of the remaining tokens.

**PoLW Deepens Scarcity:** This deflationary mechanism is deepened by Alephium's unique PoLW ([Proof-of-Less-Work](/news/post/tech-talk-1-the-ultimate-guide-to-proof-of-less-work-the-universe-and-everything-ba70644ab301/)), which further links network security and transaction fees to token scarcity.
...
In the inflationary model, passive holding leads to financial loss. In Alephium's aligned model, staking leads to productivity.

**Yield from Utility:** The fees generated by the Core dApp will be redistributed to xALPH stakers. This mechanism turns $ALPH from a passive holding into a productive asset that earns yield directly from the protocol's verified utility. Essentially, those who stake $ALPH for the long term want the chain to be more active as they also benefit from it.

**Decentralizing Growth:** Furthermore, this utility model ensures alignment by using funds to empower community initiatives (DAOs) and decentralize the growth of the entire ecosystem. In 80 years when Alephium’s emissions schedule changes, the team won’t be around to see it. It has been designed for both current and future generations to understand it, utilize it, and benefit from it.
