...
Welcome to the second part of this dev workshop session! Please make sure you go through the first part (<a href="/news/post/second-developer-workshop-re-implementing-friend-techs-smart-contract-in-ralph-806e3f6551aa" >here</a>) as part 2 starts where Part I ended.
...
Several tests are provided in the <a href="https://github.com/alephium/dev-workshop-02/blob/session-1/test/integration/friend-tech.test.ts" >GitHub repository</a> to verify if the implementation works as expected, especially all the math related to the price calculation and the fee deduction.
