...
description: Part II of Alephium's Twitter Space discussion on Proof of Work and
  Decentralization, continuing the conversation with Nervos Network about
  blockchain consensus mechanisms.
seoDescription: Alephium Twitter Space PoW and Decentralization Part II -
  continued discussion with Nervos Network. Blockchain consensus mechanisms and
  decentralization.
...
Question: **Nervos had its** [first hardfork](https://www.nervos.org/blog/the-nervos-layer-1-major-protocol-upgrade-has-arrived) **last year, and Jan Xie said, “The most difficult challenge was explaining what would happen after the hard fork to ecosystem players.” What advice could you give Alephium, which is getting to its first hardfork in the next few weeks?**
...
This closes part II! The next and last one will focus on Decentralization and how to contribute to both projects. If you have questions or want to know more, please come to Alephium’s [Discord](/discord), [Telegram](https://t.me/alephiumgroup), or reach out on [Twitter](https://twitter.com/alephium)! 📺
