...
In the same way, crypto wallets can also take advantage of NYM mixnets when sending transactions to the network. Nym provides software called NYM Connect that makes their integration easier and abstracts away complexity from the user.
