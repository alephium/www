...
In line with the release of this article, you can now visit [www.alephum.org/roadmap](https://www.alephum.org/roadmap), where you can access the history of Alephium upgrades, roadmap highlights, and see what the developers are working on next in preparation for Testnet.
