...
description: "Rhône Network Upgrade Activated! After over one year of building and testing new features, Alephium successfully activated the upgrade at 10:00 AM GMT on June 12th, 2024."
seoDescription: "Alephium Rhône Network Upgrade activated - June 12th, 2024. Over one year of building and testing new features successfully deployed."
...
Since the [Leman Upgrade](/news/post/the-leman-network-upgrade-is-live-f52c89b7dd6a), all the tech stack has been updated, worked on, and optimized. The [bridge](https://bridge.alephium.org/) was launched, major improvements to SDK & devX have been implemented, and a lot of new features for the full node were shipped, as well as multiple dApps proof-of-concepts. More integrations, a new [Extension wallet](/wallets) &amp; multiple versions of the [mobile wallet](/wallets) & explorer have been released.
...
_And_ [more](https://x.com/alephium/status/1785312194889994733)_!_
...
We’ll also be working on more full-nodes optimizations, and more tools to ease devs work. The wallets are all [getting heavy work](https://x.com/alephium/status/1778454039367459093) done on them, and of course, we’re working on hardware wallets further integrations, and more bridges!
...
A: No. The Upgrade will also reduce the reward for each block mined, so the [current emission schedule](/news/post/alephium-block-rewards-72d9fb9fde33) will not change.

**Q. Will the Rhone Upgrade Network increase the** [Transactions Per Second (TPS)](https://x.com/alephium/status/1797311071121772903)**?**

A: No. The Upgrade will reduce the [block size](https://x.com/alephium/status/1792305753677549677), meaning the blocks will contain fewer transactions. The TPS will remain the same after the Rhône Network Upgrade.
...
A: If you are running a node, please upgrade to [3.1.x](https://github.com/alephium/alephium/releases/latest) (see instructions [here](https://x.com/alephium/status/1793682101684130099)).  
If you are a service provider (exchange, wallet provider, or other), please upgrade to 3.x.x (see instructions [here](https://x.com/alephium/status/1793682101684130099)).
...
Yes, If you are a mining pool, please upgrade your node to [3.1.x](https://github.com/alephium/alephium/releases/latest) & implement the new [reference pool upgrade](https://github.com/alephium/mining-pool/pull/63/commits/5e0a9ea25616bba986883940c73aef34d547f35f) (This release also fixes a bug in contract creation that resulted in unexpected orphan blocks).  
[Here’s a quick doc](https://docs.alephium.org/integration/mining/#rhone-upgrade) about the impact of the Rhone upgrade on mining pools.
...
If you have feedback or questions, please reach out to us on [Discord](/discord) or [Telegram](https://t.me/alephiumgroup). Follow [@alephium](https://twitter.com/alephium) on Twitter to stay up-to-date!
