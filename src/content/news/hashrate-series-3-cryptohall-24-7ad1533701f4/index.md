...
CryptoHall 24 is actually my second company. I also run another company called [MyShoeFitter](https://en.myshoefitter.com/). In collaboration with the [Fraunhofer Institute](https://www.fraunhofer.de/en.html), we developed an AI model in 2019 to measure feet using pictures. The idea was to help people find the perfect shoe size when shopping online by comparing foot measurements with the shoe’s internal dimensions.
...
_Twitter & other socials links:_ [https://x.com/cryptohall24](https://x.com/cryptohall24)_,   
Website:_ [https://www.cryptohall24.com/en](https://www.cryptohall24.com/en)
