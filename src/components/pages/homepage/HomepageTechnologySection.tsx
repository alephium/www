    ...
    <SubheaderContent>
      <SideBySide>
        ...
        <TextElement>
          ...
          <p>
            ...
            data structure to deliver efficient and practical sharding. This enables Alephium to natively support over
            10,000 transactions per second while preserving a seamless 'single-chain' user experience.
          </p>
      ...
      <SideBySide>
        ...
        <TextElement isBodySmall>
          ...
          <p>
            ...
            states, like those found in Ethereum, for smart contracts while leveraging the security benefits of the UTXO
            model for asset.
          </p>
      ...
      <SideBySide reverseOnMobile>
        <TextElement isBodySmall>
          ...
          <p>
            Alephium enhances developer experience and security with its Virtual Machine, SDK, and performance-optimized
            programming language. Its MEV-aware design and built-in security measures eliminate common attack vectors,
            such as reentrancy attacks, unlimited authorization and flash loans. Alephium allows developers to focus on
            what matters and opens new possibilities for smart contracts, dApps and tokens.
          </p>
