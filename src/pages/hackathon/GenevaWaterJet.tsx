          ...
          <g clipPath="url(#a)">
            <g transform="matrix(.83333 0 0 1.0111 489.7 -68.046)">
              <g transform="matrix(4.9606 0 0 3.5079 0 404.08)">
                <path d="m363.51 626.24v-593.87" fill="none" stroke="#23c4ff" strokeWidth="10.42px" />
              </g>
              <g ref={scope}>
                {waterJetGroupTransforms.map((transform, index) => (
                  <g key={index} transform={`matrix(${transform})`}>
                    <path d="m382.71 1327.9v553.73" fill="none" stroke="#23c4ff" strokeWidth="3px" />
                  </g>
                ))}
              </g>
            </g>
            <g transform="matrix(5.3639 -.032669 -.038077 4.4489 -213.75 -475.36)">
              <path d="m0 700.53 363.51-74.284" fill="none" stroke="#23c4ff" strokeOpacity=".3" strokeWidth="8.22px" />
            </g>
            <g transform="matrix(5.7428 0 0 4.9272 3246.1 -1414.3)">
              <path d="m0 699.53 363.51-73.284" fill="none" stroke="#23c4ff" strokeOpacity=".3" strokeWidth="7.5px" />
            </g>
            <g transform="matrix(4.1339 0 0 3.5467 462.41 -4239.2)">
              <path d="m375.88 1999.3h50.298" fill="none" stroke="#23c4ff" strokeOpacity=".3" strokeWidth="10.42px" />
            </g>
