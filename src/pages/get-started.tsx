      ...
      <SubpageSection isCentered>
        ...
        <SubheaderContent isCentered>
          <Grid columns={2} gap="small">
            <Card url="https://docs.alephium.org/" border>
              <CardText>
                <h3>Documentation</h3>
        ...
        <CardsHorizontalScroller cardWidth={CARD_WIDTH} cardGap={CARD_GAP} animateCards additionalLeftPadding>
          ...
          <Card border>
            <CardText>
              ...
              <p>
                If you want more control, you can get ALPH using smart contracts. With Decentralized Exchanges (DEX) you
                can trade digital assets <strong>without handing over control of your funds</strong> to a company.
              </p>
            </CardText>
            <CardFooterButtonContainer>
              <Button squared url="https://www.coingecko.com/en/coins/alephium#markets">
