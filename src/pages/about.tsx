      ...
      content={
        <>
          <SubpageHeroSection backgroundImage={heroImage} alignContent="bottom">
            <h1>Who is building Alephium?</h1>
            <hr />
            <p>Meet the humans behind the code.</p>
          </SubpageHeroSection>
          ...
          <SubpageSection>
            <SideBySide>
              <TextElement>
                <h2>Why?</h2>
                <p>
                  Alephium was born from a simple but powerful question: What should a blockchain for the{' '}
                  <strong>next decade</strong> look like?
                </p>
                <p>
                  Conceived by <strong>Cheng Wang</strong> after witnessing firsthand how security and decentralization
                  were increasingly treated as trade-offs rather than essentials, Alephium reimagines blockchain from
                  the ground up.
                </p>
                <p>
          ...
          <SubpageSection>
            ...
            <SubheaderContent>
              <Grid columns={2} gap="small">
                <ClickableBox url="https://x.com/wachmc" align="top">
                  <ImageIcon
                ...
                <ClickableBox url="https://x.com/hongchao" align="top">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://www.linkedin.com/in/thomas-droxler-06010481/">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://www.linkedin.com/in/yuanying-l-8bb20b121/">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://x.com/mikalph">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://x.com/_nop33">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://x.com/MaudBannwart">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://www.linkedin.com/in/bertrandcaf/">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://x.com/RatkoStambolija">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://www.linkedin.com/in/jsburgos">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://x.com/_polto_">
                  <ImageIcon
                ...
                <ClickableBox align="top" url="https://www.linkedin.com/in/philipp-richner-2b0b82a5/">
                  <ImageIcon
